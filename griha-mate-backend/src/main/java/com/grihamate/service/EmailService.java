 ...
 * Handles welcome emails, verification emails, login notifications, contact notifications, etc.
 */
@Service
...
public class EmailService {
    ...
    /**
     * Sends an email notification when user verification status is updated by admin.
     * 
     * @param toEmail The recipient's email address
     * @param userName The user's full name
    ...
    public void sendVerificationStatusUpdate(String toEmail, String userName, String status, String userType) {
        ...
        try {
            ...
            // Don't throw exception - email notification is not critical for verification process
        }
    }
    ...
    public void sendContactNotification(String landlordEmail, String seekerName, String seekerEmail, 
        ...
        try {
            ...
            mailMessage.setSubject("New Contact Request for Your Property: " + (propertyTitle != null ? propertyTitle : "Property Listing"));
            mailMessage.setText(
                "Dear Landlord,\n\n" +
     ...
     * @param userName The user's full name (optional, can be "User" if not provided)
     */
