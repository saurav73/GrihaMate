        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <Link to="/explore" className="text-gray-700 hover:text-primary transition-colors font-medium">
                  Find a Room
                </Link>
              </li>
              <li>
                <Link to="/list-property" className="text-gray-700 hover:text-primary transition-colors font-medium">
                  List Your Property
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/trust-safety" className="text-gray-700 hover:text-primary transition-colors font-medium">
                  Trust & Safety
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <Link to="/help" className="text-gray-700 hover:text-primary transition-colors font-medium">
                  Help Center
                </Link>
              </li>
              <li>
                <Link to="/terms" className="text-gray-700 hover:text-primary transition-colors font-medium">
                  Terms of Service
                </Link>
              </li>
              <li>
                <Link to="/privacy" className="text-gray-700 hover:text-primary transition-colors font-medium">
                  Privacy Policy
                </Link>
              </li>
              <li>
