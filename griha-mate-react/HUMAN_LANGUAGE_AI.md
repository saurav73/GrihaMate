...
- "💖 Love it? Now it's yours forever!"
- "🎉 Hey there! Great to have you back!"
- "✨ Saved! You can revisit this gem anytime!"
...
**After (Generated by AI):**
- "😕 Hmm, those credentials don't match. Double-check?"
- "⚠️ Connection hiccup! Mind checking your internet?"
- "🤔 That didn't work. Let's try again together?"
...
**After (Generated by AI):**
- "⏳ Hang tight! Fetching awesome properties for you..."
- "📍 We'd love to show you nearby places! Enable location?"
- "🔎 Use filters to find your dream space faster!"

### 4. **Personalized Greetings**
Time-aware, personalized greetings based on the time of day and user name:

**Examples:**
- "☀️ Good morning, Sarah! Ready to explore?" (Morning)
- "🌤️ Hey Alex! Hope your afternoon is great!" (Afternoon)
- "🌙 Good evening, friend! Let's find your perfect home!" (Evening)
...
- "✨ Discover this charming 2-bedroom haven in the heart of Kathmandu! Nestled near vibrant schools and bustling markets, it's perfect for families seeking convenience and community."

### 6. **Smart Search Suggestions**
When searches yield no results or need refinement:

**Examples:**
- "🔍 Try broadening your search area or budget!"
- "💡 How about exploring nearby neighborhoods?"
- "🏠 Want me to suggest similar properties?"
...
// → "🎉 Welcome back, John! Glad you're here!"
...
toast.success(welcomeMsg) // "🎉 Hey there! Great to see you again!"

// On error
const errorMsg = await generateErrorMessage('invalid credentials', 'login')
toast.error(errorMsg) // "😕 Hmm, that doesn't match. Try again?"
```
...
toast.success(msg) // "❤️ Saved! It's waiting for you in favorites!"

// Voice search results
const msg = await generateInfoMessage("nearby search", "showing on map")
toast.success(msg) // "📍 Found your nearest options! Check the map!"
```
...
toast.success(msg) // "📧 Message sent! They'll reach out soon!"

// Booking confirmation
const msg = await generateSuccessMessage("booking", "property reserved")
toast.success(msg) // "🎊 Booked! Your new chapter begins!"
```
...
toast.success(msg) // "👋 See you soon, Sarah! Stay safe!"
```
...
The Human-Like Language AI feature transforms GrihaMate from a functional app into an **engaging, empathetic companion** for users on their home-finding journey. By leveraging Gemini AI, every interaction feels natural, supportive, and memorable. 🏠✨
